 ...
 */
public class KnowledgeChildAdapter extends BaseQuickAdapter<KnowledgeChildBean.DatasBean, BaseViewHolder> {
    public KnowledgeChildAdapter(@Nullable List<KnowledgeChildBean.DatasBean> data) {
